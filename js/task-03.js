...
const createEl = images.map(item =>
  `<li class = "gallery__item"><img class = "gallery__img", src = "${item.url}", alt = "${item.alt}", width = '200px', heigth = "200px" /></li>`)
  .join('');

console.log(listGallery);

listGallery.insertAdjacentHTML('afterbegin', createEl);
listGallery.style.backgroundColor = "green";
